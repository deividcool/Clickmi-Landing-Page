 ...
 * @public
 */
export type BestUnits<Family extends ConversionFamilyId = ConversionFamilyId, Kind extends Best.Kind = Best.Kind> = (typeof bestUnits)[Kind][Family][number][Indexes.Best.Sym];
/**
